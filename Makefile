...
help:
	...
	@echo "  make deploy-stats         Build and deploy the stats Lambda"
	...
	@echo "  make migrate-to-hashes      Rename S3 objects to hash keys, re-tag suspect photos, backfill inbox"
...
migrate-to-hashes:
	python scripts/migrate_to_hashes.py
